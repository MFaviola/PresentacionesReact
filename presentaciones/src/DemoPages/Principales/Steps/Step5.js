...
const WizardStep5 = ({ setIsStep5Valid }) => {
  const [data, setData] = useState([]);
  const [nueva, setNueva] = useState({
    coin_TelefonoCelular: "",
    coin_TelefonoFijo: null,
              ...
              <Row>
                 <Col md={6}>
                    <FormGroup>
                      ...
                      />
                      <ErrorMessage name="coin_TelefonoCelular" component="div" style={{ color: 'red' }} />
                    </FormGroup>
                  </Col>
                  <Col md={6}>
                    <FormGroup>
                      ...
                      />
                      <ErrorMessage name="coin_TelefonoFijo" component="div" style={{ color: 'red' }} />
                    </FormGroup>
                  </Col>
                </Row>
                <Row>
                <Col md={6}>
                    <FormGroup>
                      ...
                      />
                      <ErrorMessage name="coin_CorreoElectronico" component="div" style={{ color: 'red' }} />
                    </FormGroup>
                  </Col>
                  <Col md={6}>
                    <FormGroup>
