...
namespace SIMEXPRO.DataAccess
{
    public class ScriptsDataBase
    {
        ...
        public static string ValidarCorreo = "Adua.UDP_tbComercianteIndividual_ValidarCorreo";
        public static string ConfirmarCodigo = "Adua.UDP_tbComercianteIndividual_ConfirmarCodigo";
        public static string ValidarCorreo2 = "Adua.UDP_tbComercianteIndividual_ValidarCorreo2";
        public static string ConfirmarCodigo2 = "Adua.UDP_tbComercianteIndividual_ConfirmarCodigo2";
        ...
        public static string ValidarCorreoj = "[Adua].[UDP_tbPersonaJuridica_ValidarCorreo]";
        public static string ConfirmarCodigoj = "Adua.UDP_tbPersonaJuridica_ConfirmarCodigo";
        public static string ValidarCorreoj2 = "Adua.UDP_tbPersonaJuridica_ValidarCorreo2";
        public static string ConfirmarCodigoj2 = "Adua.UDP_tbPersonaJuridica_ConfirmarCodigo2";
        #endregion
