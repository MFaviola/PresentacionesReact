...
namespace SIMEXPRO.DataAccess.Repositories.Adua
{
    public class ComercianteIndividualRepository : IRepository<tbComercianteIndividual>
    {
        ...
        public RequestStatus InsertarCodigo(string correo, string codigo)
        {
            using (var db = new SqlConnection(SIMEXPRO.ConnectionString))
            {
                var parametro = new DynamicParameters();
                parametro.Add("coin_CorreoElectronico", correo);
                parametro.Add("coin_ValidarCorreo", codigo);

                var result = db.Execute(ScriptsDataBase.ValidarCorreo,
                    parametro,
        ...
        public RequestStatus ConfirmarCodigo(string codigo)
        {
            using (var db = new SqlConnection(SIMEXPRO.ConnectionString))
            {
                var parametro = new DynamicParameters();
                parametro.Add("coin_ValidarCorreo", codigo);
                parametro.Add("usua_UsuarioModificacion", 1);
                parametro.Add("coin_FechaModificacion", DateTime.Now);

                var result = db.Execute(ScriptsDataBase.ConfirmarCodigo,
                    parametro,
                     commandType: CommandType.StoredProcedure
                    );
        ...
        public RequestStatus ConfirmarCodigo2(string codigo)
        {
            using (var db = new SqlConnection(SIMEXPRO.ConnectionString))
            {
                var parametro = new DynamicParameters();
                parametro.Add("coin_ValidarCorreo2", codigo);
                parametro.Add("usua_UsuarioModificacion", 1);
                parametro.Add("coin_FechaModificacion", DateTime.Now);

                var result = db.Execute(ScriptsDataBase.ConfirmarCodigo2,
                    parametro,
                     commandType: CommandType.StoredProcedure
                    );
        ...
        public RequestStatus InsertarCodigo2(string correo, string codigo)
        {
            using (var db = new SqlConnection(SIMEXPRO.ConnectionString))
            {
                var parametro = new DynamicParameters();
                parametro.Add("coin_CorreoElectronicoAlternativo", correo);
                parametro.Add("coin_ValidarCorreo2", codigo);

                var result = db.Execute(ScriptsDataBase.ValidarCorreo2,
                    parametro,
                     commandType: CommandType.StoredProcedure
                    );
