...
namespace SIMEXPRO.BussinessLogic.Services.EventoServices
{
    public class AduanaServices
    {
        ...
        public ServiceResult InsertarCodigo(string correo, string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _comercianteIndividualRepository.InsertarCodigo(correo, codigo);
        ...
        public ServiceResult ConfirmarCodigo(string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _comercianteIndividualRepository.ConfirmarCodigo(codigo);
        ...
        public ServiceResult InsertarCodigo2(string correo, string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _comercianteIndividualRepository.InsertarCodigo2(correo, codigo);
        ...
        public ServiceResult ConfirmarCodigo2(string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _comercianteIndividualRepository.ConfirmarCodigo2(codigo);
        ...
        public ServiceResult InsertarCodigoj(string correo, string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _personaJuridicaRepository.InsertarCodigoj(correo, codigo);
        ...
        public ServiceResult ConfirmarCodigoj(string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _personaJuridicaRepository.ConfirmarCodigoj(codigo);
        ...
        public ServiceResult InsertarCodigoj2(string correo, string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _personaJuridicaRepository.InsertarCodigoj2(correo, codigo);
        ...
        public ServiceResult ConfirmarCodigoj2(string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _personaJuridicaRepository.ConfirmarCodigoj2(codigo);
